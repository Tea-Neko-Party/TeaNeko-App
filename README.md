...
<img src="https://img.shields.io/badge/Spring_Boot-4.1.0-brightgreen" alt="Spring Boot 4.1.0">
<img src="https://img.shields.io/badge/Gradle-9.5.0-02303A" alt="Gradle 9.5.0">
...
| 步骤 | 说明                                      | bash                                                          |
|:--:|-----------------------------------------|---------------------------------------------------------------|
| 1  | - 安装 Java 25<br> - 安装任意兼容 `JDBC` 的数据库环境 |                                                               |
