...
import org.zexnocs.teanekoagent.llm_api_framework.tool.LLMObjectFunctionParameter;
import org.zexnocs.teanekoagent.llm_api_framework.tool.LLMStringFunctionParameter;
import org.zexnocs.teanekoagent.llm_api_framework.tool.LLMTool;
...
```java
import org.zexnocs.teanekoagent.llm_api_framework.tool.api.LLMToolMapping;
import org.zexnocs.teanekoagent.llm_api_framework.tool.api.LLMToolProvider;
...
import org.zexnocs.teanekoagent.llm_api_framework.tool.api.LLMToolMapping;
import org.zexnocs.teanekoagent.llm_api_framework.tool.interfaces.ILLMToolProvider;
import org.zexnocs.teanekocore.framework.description.Description;
...
```java
var prompt = LLMPrompt.builder()
        .messages(messages)
        .options(LLMModelOptions.builder()
