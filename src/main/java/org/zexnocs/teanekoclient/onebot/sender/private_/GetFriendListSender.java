...
import org.zexnocs.teanekoclient.onebot.data.send.params.private_.GetFriendListParamsData;
 ...
 * @since 4.0.12
 */
@Component("GetFriendListSender")
public class GetFriendListSender extends AbstractOnebotSender<GetFriendListParamsData, GetFriendListResponseData> {
     ...
     */
    @Autowired
    public GetFriendListSender(ISenderService senderService,
                               OnebotClient client,
