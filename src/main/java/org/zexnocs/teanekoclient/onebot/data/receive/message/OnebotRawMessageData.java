...
public class OnebotRawMessageData {
    // ----- 一般字段 -----
    /// self_id 机器人QQ号
     ...
     */
    public static OnebotRawMessageData fromJson(String json, ObjectMapper mapper) {
        return mapper.readValue(json, OnebotRawMessageData.class);
    }
}
